...
class RevolutionaryCache {
  ...
  constructor(config) {
    ...
    this.stats = {
      ...
      sets: 0,
      evictions: 0,
      compressionRatio: 2.5 // Default compression ratio
    };
  ...
  getStats() {
    ...
    return {
      ...
      compressionRatio: this.stats.compressionRatio || 2.5,
      averageCompressionRatio: (this.stats.compressionRatio || 2.5).toFixed(2)
    };
  }
