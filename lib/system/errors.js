...
module.exports = {
  ...
  TimeoutError,
  ConfigError,
  // Keep old names for backwards compatibility temporarily
  RevolutionaryError: BasicError,
  RevolutionaryApiError: ApiError,
  RevolutionaryTimeoutError: TimeoutError,
  RevolutionaryConfigError: ConfigError
};
