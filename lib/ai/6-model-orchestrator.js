...
class SixModelOrchestrator extends EventEmitter {
    ...
    selectModels(request) {
        ...
        // Return the array of selected models as expected by tests
    ...
    async executeParallel(models, request) {
        ...
        try {
            ...
            const modelPromises = models.map(async (model) => {
                ...
                try {
                    ...
                    return {
                        ...
                        thinkingSteps: response.thinking?.steps,
                        reasoning: response.thinking?.reasoning,
            ...
            // Get successful results in the format tests expect
            ...
            // Return array of results as expected by tests
