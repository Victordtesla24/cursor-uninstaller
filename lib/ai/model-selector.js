...
class ModelSelector {
   ...
   */
  recordModelExecution(modelName, success, latency, error = null) {
  ...
  getBasicFallbacks() {
    return [
      {
        name: 'claude-3-haiku',
        config: this.availableModels['claude-3-haiku'],
        performance: this.performanceHistory.get('claude-3-haiku')
      },
      {
        name: 'gpt-3.5-turbo',
