...
class BaseLanguageAdapter extends EventEmitter {
    ...
    async performContextExtraction(filePath, position, options) {
        throw new Error('performContextExtraction must be implemented by subclass');
    }
    ...
    async performSymbolResolution(filePath, symbol, position) {
        throw new Error('performSymbolResolution must be implemented by subclass');
    }
    ...
    async performLinting(filePath, content) {
        throw new Error('performLinting must be implemented by subclass');
    }
    ...
    async performFormatting(content, options) {
        throw new Error('performFormatting must be implemented by subclass');
    }
