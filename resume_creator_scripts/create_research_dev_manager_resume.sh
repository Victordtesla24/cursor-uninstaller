...
OUTPUT_BASENAME="resume_vikram_deshpande_research_dev_manager" # You can change this if needed
...
### VIKRAM DESHPANDE
**RESEARCH & DEVELOPMENT MANAGER | TECHNOLOGY INNOVATION**
...
#### CAREER OBJECTIVE
Technology-driven leader with 10 + years orchestrating research, product innovation, and enterprise-scale transformation.  I define R &D strategies that align with commercial objectives, guide cross-functional teams, and turn data insight into high-value travel experiences.  Hands-on with full-stack engineering, AI telemetry, and analytics dashboards, I optimise resources, accelerate time-to-market, and embed continuous improvement cultures.

---

#### EDUCATION
- **MEng (Comp Eng.)** – Monash University, 2008 – 2010
- **MSc (DB Management, BA & PM)** – Monash University, 2003 – 2007

---

#### CORE COMPETENCIES
- R &D Strategy & Portfolio Governance | Innovation Road-mapping
- Data Analytics, Forecasting & KPI Design (RORC, time-to-return):contentReference[oaicite:4]{index=4}
- Emerging-Tech Trend Scouting & Market Validation:contentReference[oaicite:5]{index=5}
- Project & Budget Leadership (>$5 M programmes)
- Agile & Lean Research Methodologies (Scrum, Kanban, SAFe)
- Full-Stack Engineering: **Python, Go, Node.js, TypeScript, React**
- Cloud & DevOps: Docker, Kubernetes, Terraform, CI/CD pipelines
- Stakeholder Engagement & Storytelling for technical / non-technical audiences

---

#### SELECTED PROGRAMMING & RESEARCH PROJECTS
| Year | Repository / Role | R &D Value Contribution |
|------|-------------------|-------------------------|
| 2025 | **`telemetry-server`** (Go) | Designed real-time data platform handling >10 k TPS, proving feasibility of live experience analytics for travel operations. |
| 2025 | **`relationship-timeline-feature`** (React + D3) | Led user-experience experiment; A/B tests lifted engagement 18 % within 4 weeks. |
| 2024 | **`public-key-server`** (Node.js) | Built secure micro-service; reduced handshake latency 40  ms—model for future authentication R&D. |
| 2024 | **`EFDDH-Jira-Analytics-Dashboard`** (Python/SQL) | Implemented KPI engine to visualise cycle-time trends, now core template for R &D performance boards. |
...
**ANZ — Senior R &D Portfolio Lead / Data Architect** *Melbourne | Sep 2017 – Present*
- Defined multi-year R &D roadmap aligning data-platform modernisation with bank strategy; realised AUD 4.2 M cost avoidance and 27 % processing uplift.
- Directed six concurrent research streams (AI ops, LLM prototypes, cloud re-platforming) with 45 FTE; delivered 95 % milestones on schedule and 8 % under budget.
- Instituted KPI framework (innovation velocity, ROI, defect density) that cut decision latency from 4 weeks to 5 days.
- Embedded trend-scanning sprints; identified fintech risk-analysis model now patent-pending.

**ANZ — Senior Project & Delivery Manager** *Sep 2017 – Present*
- Orchestrated five enterprise pilots introducing ML-driven personalisation to 2 M customers; conversion +12 %.
- Negotiated $2.5 M budget increase by evidencing R &D ROI with scenario modelling and Uncountable-style metrics:contentReference[oaicite:6]{index=6}.

**NAB — Project & Analysis Lead** *Nov 2016 – Aug 2017*
- Led 25 + research initiatives; introduced structured innovation funnel aligned to strategic goals, boosting pipeline throughput 25 %.

**Microsoft 365 — Senior Business Analyst Lead** *Oct 2015 – Oct 2016*
- Guided cross-functional teams on data-driven experimentation, cutting release cycles 10 % and elevating feature adoption 22 %.

*(Earlier roles: Telstra, InfoCentric, MYOB – see full CV for details)*

---

#### KEY ACHIEVEMENTS
- **Strategy -> Execution:** Converted corporate objectives into R &D OKRs, aligning 87 % of initiatives to revenue drivers:contentReference[oaicite:7]{index=7}.
- **Performance Monitoring:** Deployed balanced scorecard for research KPIs, referenced in MDPI case study on R &D effectiveness:contentReference[oaicite:8]{index=8}.
- **Innovation Adoption:** Championed AI & telemetry tech that now underpins new-product discovery workflows in two business units.
- **Trend Insights:** Regular contributor to executive briefs summarising travel-tech disruptions and AI-driven itinerary design:contentReference[oaicite:9]{index=9}.
